...
// Import Quantity component dynamically with { ssr: false }
const DynamicQuantity = dynamic(() => import('@/app/component/Quantity'), { ssr: false });
      ...
      <div className="container mt-3 color-section">
        <div className="row g-3">
          <div className="col-md-4 col-lg-4 col-sm-4">
            <img className="w-100" style={{ height: 350 }} src={`../${s.image}`} alt="Product" />
          </div>
          <div className="col-md-8 col-sm-8 col-lg-8">
            <div className="content ms-2 pt-2 pb-2">
              ...
              <p>
                Only <span className="text-danger fw-bold">{s.total}</span> Left On Stock
              </p>
              ...
              <DynamicQuantity total={s.total} />
              <button
                className="btn btn-info rounded-0"
                onClick={() => handleAddToCart(s.id, color, amount, product)}
              >
                Add To Cart
              </button>
            </div>
